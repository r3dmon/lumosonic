...
```bash
git remote add encore encore://software-company-landing-k3vi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/software-company-landing-k3vi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/software-company-landing-k3vi/settings/integrations/github)
